  ...
  return knex('listings').del()
    .then(function () {
      ...
      return knex('listings').insert([
        ...
        {id: 3, user_id: 99903, title: 'Join us: BYO sawn off shotgun', description: 'one of our broz got locked up last week so now we need a new guitarist for our alternative folk band, the lamenting daffodils..but its a members only band so i guess we now looking for another member. we a bit low on budget so cant afford to get u a real leather patch but we run community needlepoint workshops every other week so u can make ur own. if you want to look more staunch ur welcom to provide ur own accessories at ur own expense. u know, like sawn off rifles or ummm.. pitbulls on leather studded chains- let our accountant know as these are tax rebateable'}
